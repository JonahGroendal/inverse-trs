...
module.exports = async function (deployer, network, accounts) {
  ...
  await deployer.link(MathUtils, Rates);
  await deployer.deploy(MockMath)
  await deployer.deploy(MockPriceFeed)
  await deployer.deploy(Rates, MockPriceFeed.address)
  ...
  await deployer.deploy(Swap, Rates.address, tokenH.address, tokenL.address, MockWETH.address)
