...
contract("Swap", accounts => {
    ...
    it("should mint 10,000 EUSD in exchange for 10 WETH", async () => {
        ...
        await swap.buyFixed(toWei(10000))
    ...
    it("should burn 10,000 EUSD and return 10 WETH", async () => {
        ...
        await swap.sellFixed(toWei(10000))
    ...
    it("should return rest of WETH to EUSD holders if undercollateralized", async () => {
        ...
        await swap.buyFloat(toWei(11), { from: accounts[3] })
        await swap.buyFixed(toWei( 2077), { from: accounts[0] })
        await swap.buyFixed(toWei(10101), { from: accounts[1] })
        await swap.buyFixed(toWei(  304), { from: accounts[2] })
        ...
        await swap.sellFixed(toWei( 2077), { from: accounts[0] })
        await swap.sellFixed(toWei(10101), { from: accounts[1] })
        await swap.sellFixed(toWei(  304), { from: accounts[2] })
    ...
    it("should maintian peg if WETH price drops", async () => {
        ...
        await swap.sellFixed(toWei(10101), { from: accounts[1] });
        await swap.sellFixed(toWei(  304), { from: accounts[2] });
        await swap.sellFloat(toWei(11), { from: accounts[3] });
...
/*
    it("should give  2x loss to LETH holders if WETH price drops with system at a 2.0 coll ratio", async () => {
        ...
        await swap.buyFloat(toWei(25), { from: accounts[0] });
        await swap.buyFloat(toWei(75), { from: accounts[1] });
        await swap.buyFixed(toWei(15000), { from: accounts[2] });
        await swap.buyFixed(toWei(85000), { from: accounts[3] });
        ...
        await swap.sellFloat(toWei(25), { from: accounts[0] });
        await swap.sellFloat(toWei(75), { from: accounts[1] });
        await swap.sellFixed(toWei(15000), { from: accounts[2] });
        await swap.sellFixed(toWei(85000), { from: accounts[3] });
    ...
    it("should give  3x loss to LETH holders if WETH price drops with system at a 1.5 coll ratio", async () => {
        ...
        await swap.buyFloat(toWei(25), { from: accounts[0] });
        await swap.buyFloat(toWei(75), { from: accounts[1] });
        await swap.buyFixed(toWei(115000), { from: accounts[2] });
        await swap.buyFixed(toWei(85000), { from: accounts[3] });
        ...
        await swap.sellFloat(toWei(25), { from: accounts[0] });
        await swap.sellFloat(toWei(75), { from: accounts[1] });
        await swap.sellFixed(toWei(115000), { from: accounts[2] });
        await swap.sellFixed(toWei(85000), { from: accounts[3] });
    ...
    it("should give 11x gain to LETH holders if WETH price rises with system at a 1.1 coll ratio", async () => {
        ...
        await swap.buyFloat(toWei(75), { from: accounts[1] });
        await swap.buyFixed(toWei(115000), { from: accounts[2] });
        await swap.buyFixed(toWei(885000), { from: accounts[3] });
        ...
        await swap.sellFloat(toWei(75), { from: accounts[1] });
        await swap.sellFixed(toWei(115000), { from: accounts[2] });
        await swap.sellFixed(toWei(885000), { from: accounts[3] });
    ...
    it("should revert if priority fee is greater than the maximum allowed", async () => {
        ...
        try {
            await swap.buyFixed(toWei(10000), { maxPriorityFeePerGas: 4000000000 })
        } catch(e) {
            return;
        }
        assert.fail();
    ...
    it("should not revert if priority fee is the maximum allowed", async () => {
        await weth.approve(swap.address, toWei(10))
        await swap.buyFixed(toWei(10000), { maxPriorityFeePerGas: 3000000000 })
        await eusd.approve(swap.address, toWei(10000))
        await swap.sellFixed(toWei(10000), { maxPriorityFeePerGas: 3000000000 })
    })
